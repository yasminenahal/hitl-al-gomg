[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.13868609.svg)](https://doi.org/10.5281/zenodo.13868609)
...
**For training a predictor of DRD2 bioactivity:**
        ...
        python -m hitl_al_gomg.models.train --path_to_train_data data/train/drd2_train --path_to_test_data data/test/drd2_test --path_to_predictor data/predictors/drd2 --path_to_simulator data/simulators/drd2 --path_to_param_grid example_files/rfc_param_grid.json --train True --demo True
...
- The directory `example_files/` contains examples of hyperparameter grids to run cross-validation for `scikit-learn` Random Forest models.
