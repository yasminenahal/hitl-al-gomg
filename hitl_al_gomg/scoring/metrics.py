...
def get_pairwise_structural_metrics(generated_set, reference_set, metric):
    ...
    if metric == "frag":
        generated_frag, reference_frag = FragMetric().precalc(generated_set), FragMetric().precalc(reference_set)
        return FragMetric().metric(pgen=generated_frag, pref=reference_frag)
    
    if metric == "snn":
        generated_snn, reference_snn = SNNMetric().precalc(generated_set), SNNMetric().precalc(reference_set)
        return SNNMetric().metric(pgen=generated_snn, pref=reference_snn)
    
    if metric == "fcd":
        generated_fcd, reference_fcd = FCDMetric().precalc(generated_set), FCDMetric().precalc(reference_set)
